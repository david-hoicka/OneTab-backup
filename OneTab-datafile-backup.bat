...
echo F | xcopy C:\Users\David101\AppData\Roaming\Mozilla\Firefox\Profiles\t71tluuq.default\jetpack\extension@one-tab.com\simple-storage\store.json  G:\OneDrive\z-backup-OneTab\Firefox-OneTab-backups\store(%yy%-%mm%-%dd%-%hh%-%tt%-%ss%).json /M
